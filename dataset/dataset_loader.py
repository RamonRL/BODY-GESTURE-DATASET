...
class IRIGesture(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # Each sample formed by last video frame (image), gesture label vector (gesture), and 3D joints (landmarks)
        sample = {'landmarks': landmarks[-1], 'gesture': gesture, 'image': image}
